...
StripeEvent.configure do |events|
  events.subscribe 'invoice.paid' do |event|
    ...
    Transaction.create(plan_name: plan_name, amount: event.data.object.amount_paid.to_i/100, buyer_name: buyer_name, buyer_email: event.data.object.customer_email)
